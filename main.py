...
def build_menu_page(page: int, is_admin: bool) -> InlineKeyboardMarkup:
    ...
    page_titles = ["⚡ Quick Access", "🔍 OSINT Tools", "🌐 Info & Discovery", "🇮🇳 India / Pak", "🎬 AI Media Studio"]
    total = len(pages)
    rows = pages[page][:]
    nav = []
    if page > 0:
...
def main_menu_text(user, uid=""):
    ...
    try:
        ...
        total_users = "?"
    return (
        f"⚡ <b>SHUVO BOT</b> — <i>Ultimate AI Powerhouse</i>\n"
        f"━━━━━━━━━━━━━━━━━━━━━\n\n"
        f"<blockquote>"
        ...
        f"</blockquote>\n\n"
        f"🛠  <b>30+ Tools</b>  •  🤖 <b>AI Chat</b>  •  🔍 <b>OSINT</b>  •  🎨 <b>Media</b>\n"
        f"━━━━━━━━━━━━━━━━━━━━━\n"
        f"<i>Powered by LLaMA 3.3 70B · @Shuvobhai</i>"
    )
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if is_new_user:
        ...
        extra_note = (
            ...
            f"━━━━━━━━━━━━━━━━\n"
            f"🎁  <b>+3 Welcome Credits</b> added to your wallet!\n"
            f"📅  Claim <b>+3 more</b> every 24 hours via /start\n"
            f"🚀  Use the menu below to explore all tools\n"
            f"💡  Tip: /ai can run ANY tool for you!"
            f"</blockquote>"
        )
    ...
    if claimed:
        extra_note = (
            f"\n\n<blockquote>"
            f"✅ <b>Daily Claim Successful!</b>\n"
            f"━━━━━━━━━━━━━━━━\n"
            f"🎁  <b>+3 Credits</b> added to your wallet!\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    text = bq(
        "📋 <b>SHUVO BOT — Command List</b>\n"
        "━━━━━━━━━━━━━━━━━━━━━\n\n"

        "🤖 <b>AI TOOLS</b>  <i>(Free)</i>\n"
        "┣ /ai &lt;prompt&gt; — Super AI chat\n"
        "┣ /image &lt;prompt&gt; — AI image gen\n"
        "┣ /nasaapod — NASA photo of the day\n"
        "┗ /nasaepic — NASA Earth live shots\n\n"

        "🎨 <b>AI CREATION</b>  <i>(Credits)</i>\n"
        "┣ /imagegen &lt;prompt&gt; — HD image (3 cr)\n"
        "┣ /music &lt;prompt&gt; — AI music (5+ cr)\n"
        "┣ /videogen &lt;prompt&gt; — AI video (50 cr)\n"
        "┣ /sprite &lt;prompt&gt; — Game sprite (3 cr)\n"
        "┣ /model3d &lt;prompt&gt; — 3D model (190 cr)\n"
        "┗ /editimage &lt;desc&gt; — Edit photo (10 cr)\n\n"

        "🔍 <b>OSINT TOOLS</b>  <i>(1 Credit each)</i>\n"
        "┣ /userid — TG ID → phone\n"
        "┣ /usernum — Username → phone\n"
        "┣ /indinfo — Indian number info\n"
        ...
        "┣ /gen — Add credits\n"
        "┣ /ban /unban — Ban user\n"
        "┣ /broadcast — Blast message\n"
        "┣ /gencode — Create redeem code\n"
        "┣ /listcodes — List all codes\n"
        "┣ /delcode — Delete a code\n"
        "┗ /stats — Bot statistics\n\n"

        "🧹 <b>GROUP TOOLS</b>\n"
        "┣ /clearmsg on/off — Auto-delete msgs\n"
        "┣ /blacklist — Block a message pattern\n"
        "┗ /unblacklist — Unblock pattern\n\n"

        "━━━━━━━━━━━━━━━━━━━━━\n"
        "💡 <b>Pro Tip:</b> Just tell /ai what you want!\n"
        "<i>Example: \"Check IP 8.8.8.8\" or \"FF stats 123456\"</i>\n\n"
        "👺 DEV @Shuvobhai ✅"
    )
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "back_home":
        ...
        text = bq(
            ...
            "┗ /nasaepic — NASA Earth live shots\n\n"
            "🔍 <b>OSINT TOOLS</b>  <i>(1 Credit each)</i>\n"
            "┣ /userid /usernum /indinfo /instainfo\n"
            "┣ /pincode /ifsc /ipinfo /emailrep\n"
            "┣ /vehicle /vehiclerc /upi /paknum\n"
            "┗ /aadhar /gst /pan /ffstats /weather\n\n"
            "🎨 <b>AI CREATION</b>  <i>(Credits)</i>\n"
            ...
            "┗ /voice — Text to speech\n\n"
            "━━━━━━━━━━━━━━━━━━━━━\n"
            "💡 <b>Tip:</b> /ai can run ANY tool for you!\n\n"
            "👺 DEV @Shuvobhai ✅"
        )
